...
class P3_Recent_Comments extends WP_Widget {
	function P3_Recent_Comments() {
		$this->WP_Widget( false, __( 'P3 Recent Comments', 'P3' ), array( 'description' => __( 'Recent comments with avatars.', 'P3' ) ) );
...
?>
	...
	public static function comment_url_maybe_local( $comment ) {
	...
	public static function recent_comments( $num_to_show ) {
		global $wpdb;
	...
	public static function single_comment_html($comment, $avatar_size ) {
		$no_avatar = $avatar_size == '-1';
